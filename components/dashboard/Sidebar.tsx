...
export default async function Sidebar() {
    ...
    return (
        ...
        items-start justify-between pl-6 gap-8'>
            <h1 className="text-3xl my-6 font-medium flex items-center tracking-tight capitalize">
                <svg className="w-12 -ml-6 h-12 mr-4 stroke-black fill-black dark:stroke-white dark:fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="45.9 8.021 87.99 54.15">
