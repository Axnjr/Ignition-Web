...
export default function Nav({ status, signIn, signOut }: { status: string, signIn: any, signOut: any }) {
    ...
    return (
        <>
            <nav className="w-full h-16 flex justify-between items-center pl-4 pr-2 sm:px-8 fixed top-0 z-50
                min-[1400px]:px-32 m-auto right-0 left-0 backdrop-blur-xl border-b border-myborder">
                ...
                <div className="hidden min-[960px]:flex justify-between items-center gap-6 border border-myborder rounded-full py-2 px-4 bg-black">
