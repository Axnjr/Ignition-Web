    ...
    return (
        <div className="h-fit py-32 bg-black">
            <div className="w-full h-fit relative text-center">
                <h1 className="text-7xl font-medium mt-20 w-fit px-10 py-6 rounded-3xl 
                m-auto text-white tracking-tight ">
                    Real quick, easy, fast
                </h1>
                <p className="text-xl text-mybg2 w-2/3 m-auto">
                ...
                <div className="w-full h-full p-6 bg-black relative">
                    <section className="w-full m-auto relative pt-12">
                        ...
                        <div className="flex items-center w-10/12 m-auto gap-2 rounded-xl justify-center px-2 py-3">
                            {/* bg-gradient-to-b from-gray-950 to-black border border-myborder */}
                            <Select onValueChange={(item) => {
                                setGroup(prev => item);
                            }}>
                                <SelectTrigger className="w-[15%] border border-myborder bg-black h-12">
                            ...
                            <input onChange={(e) => setMessage(e.target.value)} className="w-[75%] h-12 px-4 rounded-lg outline-none border border-myborder bg-black" placeholder="Type your message .." type="text" />
                            <span onClick={() => {
                        ...
                        <div className="flex flex-col justify-start items-center pt-2 border border-myborder rounded-xl w-10/12
